...
\begin{frame}{PhD Thesis}
  \begin{block}{Improving Intrusion Detection in Distributed Systems with Federated Learning}
    \begin{itemize}
      \item \alert{\bfseries Goal:} Can federated learning realistically be used to as a mean of collaboration between organizations for intrusion detection?
      \item Supervised by \textexample{Yann Busnel}, advised by \textexample{Fabien Autrel} and \textexample{Marc-Oliver Pahl}.
...
\input{sections/phd/21_fids_slr.tex}
\input{sections/phd/22_metro.tex}
\input{sections/phd/23_assessment.tex}
\input{sections/phd/24_radar.tex}
\input{sections/phd/25_takeaways.tex}
