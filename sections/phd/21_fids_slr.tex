...
\begin{frame}{Case Study}
  ...
  \alt<4->{\footcite*{kairouz_AdvancesOpenProblems_2021}}{\footnotetext{Network Intrusion Detection System}}
  % \begin{figure}
  %   \centering
  %   \makebox[\textwidth][c]{\includegraphics[width=.9\textwidth]{figures/thesis/intro/mlp-workflow.pdf}}
